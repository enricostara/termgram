...
function createClientForNewUser() {
    ...
    return new Promise(function (fulfill, reject) {
        client = createClient(primaryDC, function () {
...
function signIn(phoneNumber, codeHash, code) {
    return new Promise(function (fulfill, reject) {
        client.once('error', reject);
        client.signIn(phoneNumber, codeHash, code, function (result) {
            if ('mtproto.type.Rpc_error' == result.typeName) {
...
function signUp(phoneNumber, codeHash, code, firstName, lastName) {
    return new Promise(function (fulfill, reject) {
        client.once('error', reject);
        client.signUp(phoneNumber, codeHash, code, firstName, lastName, function (result) {
            if ('mtproto.type.Rpc_error' == result.typeName) {
                reject(new Error(result.error_message));
            } else {
                fulfill(result);
